...
- [ ] **Phase e — `chat.*` deprecation-warning** — Coexist-Policy aus ADR-0021 §6. `ChatSessions.spawn` loggt `[deprecated] chat.* wird in v1.x.+1 entfernt — use pty.*` bei jedem Aufruf. KEIN delete in diesem PR. Removal frühestens v1.x.+1.
